allOrders=[], editProdId=null, newImages=[], existImages=[], pushHist=[], allZones=[], currentOrderId=null, ordersFilter='';
...
// ── API ───────────────────────────────────────────────────────────────────
const api = (p,o={}) => fetch(p,{...o,credentials:'include',headers:{'Authorization':'Bearer '+TOKEN,...(o.headers||{})}});
